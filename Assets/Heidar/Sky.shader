...
Shader "Shader Forge/Sky" {
    Properties {
        ...
        _Metallic ("Metallic", Range(0, 1)) = 0.8803419
...
/// Final Color:
                ...
                UNITY_APPLY_FOG_COLOR(i.fogCoord, finalRGBA, fixed4(1,0,0.8896551,1));
                return finalRGBA;
            }
            ENDCG
        }
